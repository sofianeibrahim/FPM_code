function cap = capture_scan_reflection_2( ...
    nstrip_bf,...
    nstrip_df1,...
    nstrip_df2,...
    rings_bf,...
...
nstrip_bf.Brightness=get_opt(opts,'brightness',0.6);
nstrip_df1.Brightness=nstrip_bf.Brightness;
nstrip_df2.Brightness=nstrip_bf.Brightness;
...
for i = 1:Ndf
    ...
    %% LED ON
    if current_ring<=2
        writeColor(nstrip_df1,led_id,'red');
    else
        writeColor(nstrip_df2,led_id,'red');
    end
    ...
    %% LED OFF
    if current_ring<=2
        writeColor(nstrip_df1,led_id,[0 0 0]);
    else
        writeColor(nstrip_df2,led_id,[0 0 0]);
    end
...
for n=1:25
    writeColor(nstrip_df1,n,[0 0 0]);
end
for n=1:80
    writeColor(nstrip_df2,n,[0 0 0]);
end
